package com.r2g.msproduct.controller;
...
import com.r2g.msproduct.util.ErrorMenssage;
...
public class ProductController {
    ...
    public ResponseEntity<Product> updateStockProduct(@PathVariable Long id, @RequestParam(name = "       ", required = true) Double quantity) {
